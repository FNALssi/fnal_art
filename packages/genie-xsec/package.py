...
class GenieXsec(Package):
    ...
    resource(name='DefaultPlusMECWithNC',
    ...
    resource(name='DefaultPlusValenciaMEC',
    ...
    resource(name='LocalFGNievesQEAndMEC',
    ...
    resource(name='ValenciaQEBergerSehgalCOHRES',
