...
class ArtSuite(BundlePackage):
    ...
    with when("@s124"):
        ...
        depends_on("art-root-io@1.12.04 cxxstd=17", when="+root")
        depends_on("boost@1.82.0+atomic+chrono+date_time+exception+filesystem+graph+iostreams+json+locale+log+math+multithreaded+program_options+random+regex+serialization+shared+signals+system+test+thread+timer+wave cxxstd=17") # Sum of all needed libraries...
        depends_on("canvas@3.15.02 cxxstd=17")
        depends_on("canvas-root-io@1.12.03 cxxstd=17", when="+root")
        depends_on("catch2@3.3.2") 
        depends_on("cetlib@3.17.01 cxxstd=17")
        depends_on("cetlib-except@1.09.01 cxxstd=17")
        depends_on("cetmodules@3.21.02")
        depends_on("clhep@2.4.6.4 cxxstd=17")
        depends_on("fftw@3.3.10")
        depends_on("fhicl-cpp@4.18.01 cxxstd=17")
        depends_on("gsl@2.7")
        depends_on("hep-concurrency@1.09.01 cxxstd=17")
        depends_on("libxml2@2.9.12")
        depends_on("messagefacility@2.10.02 cxxstd=17")
        ...
        depends_on("tbb@2021.9.0 cxxstd=17")
        depends_on("xrootd@5.5.5 cxxstd=17")
    with when("@s123"):
        depends_on("cmake@3.26.3")
