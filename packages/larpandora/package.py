...
class Larpandora(CMakePackage):
    ...
    version("09.10.02.02", sha256="593b9702723987060ac957127e23e306a651a1768221d513e9b437f11d5125eb")
    ...
    def cmake_args(self):
        args = [
            ...
            self.define_from_variant("CMAKE_PREFIX_PATH", self.spec["py-torch"].package.cmake_prefix_paths[0]),
