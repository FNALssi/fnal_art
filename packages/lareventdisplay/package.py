...
class Lareventdisplay(CMakePackage):
    ...
    version("09.02.08.02", sha256="fe3623fbc9438f96e66927c8c5b24114b5d0fef0f2e8dd0576b290d0fc9b4147")
    ...
    version("mwm1", tag="mwm1", git="https://github.com/marcmengel/lareventdisplay.git",)
