...
class Ifdhc(MakefilePackage):
    ...
    version("2.8.1", sha256="caf5c88cd6eed51eb425b01140bf6a36fe5f3fad98b9bd12ff5b0896f803c847")
    ...
    def setup_run_environment(self, run_env):
        ...
        # move ifdhc_config bin path ahead of ours
        run_env.remove_path("PATH", self.spec["ifdhc-config"].prefix.bin)
